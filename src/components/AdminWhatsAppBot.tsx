    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      ...
      {mainTab === 'chatbot_studio' && (
        <div className="space-y-4">
          {/* Banner de acceso directo al Laboratorio Sandbox */}
          <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 rounded-3xl p-5 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm border border-purple-800/40">
            <div className="flex items-center space-x-3.5">
              ...
              <div>
                <p className="text-xs font-bold text-white flex items-center gap-2">
                  <span>🧪 ¿Querés probar tus mensajes y compras sin otro celular?</span>
                  <span className="px-2 py-0.5 rounded-full text-[9px] font-bold bg-purple-500/30 text-purple-200 border border-purple-400/30">Nuevo Sandbox</span>
                </p>
                <p className="text-[11px] text-purple-200/90 mt-0.5">
                  Probá compras con gramajes libres (25g, 50g, 75g), cupones, estados de pedido y filtros anti-spam con 4 perfiles simulados.
                </p>
              </div>
            </div>
            <button
              type="button"
              onClick={() => onOpenLab ? onOpenLab() : setMainTab('test_lab')}
              className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold rounded-xl shadow transition-colors flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
            >
