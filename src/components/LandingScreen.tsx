    ...
    <div className="bg-white overflow-hidden">
      {sections.map(section => {
        switch (section.section_type) {
          case 'hero':
            return (
              <section key={section.id} className="relative bg-gradient-to-b from-pink-50 via-purple-50/40 to-white pt-12 pb-16 sm:pb-24 lg:pt-16 overflow-hidden">
          ...
          case 'about': {
            ...
            return (
              <section key={section.id} className="py-20 sm:py-24 bg-white">
          ...
          case 'categories': {
            ...
            return (
              <section key={section.id} className="py-20 bg-gradient-to-tr from-pink-50/50 via-white to-purple-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
