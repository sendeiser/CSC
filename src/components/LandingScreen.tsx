          ...
          case 'hero': {
            ...
            return (
              <section key={section.id} className="relative min-h-[85vh] flex items-center bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 overflow-hidden">
                  ...
                  {/* Wave bottom (only drawn if next section is not banners, since PromoCarousel has its own matching wave integration) */}
                  {sections.find(s => s.visible !== false && s.section_type !== 'hero')?.section_type !== 'banners' && (
