...
export const PRODUCTS: Product[] = [
  {
    ...
    category: 'Gomitas',
    price: 12.50,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCpiDU1FUsKrUy77WDq6JPCy2kU9uvvnAJaJB_HyQW6SFHSnAiGg4-XadyKR84IP_DOgm4j03h32ZL8T-w3KdxVPPebxMSWvLYbApoy12uPtJO_oCxG9fyXZK_g4qdU0cksgx1E2pWA1RT1RAyvc52ad6l9g0ytPcprx-NV262CI5FU-iUEm4iZ83BDlvcIylfZ57Nb__5-AsVdqhSDmtsgwfDM1znhM1PxdZfzhyPpmfV0qbU9wFxkfRcPZ6LrZMNVznHA15cuX8E',
  ...
  },
  {
    ...
    category: 'Caramelos',
    price: 3.50,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAhkxMF82LeaMwKBJ7rZZXe6zxHsqZUZmg76n2MkPA6Z2J23q0GVh0kwDq0R6FXfR57rrPIUj4jbhJCQzB44lGHuC6_Ugoj1TT321U8hyHhvkkdSkDsGh2kUOUrrFRE5vMLoqigi2nUAozMwQF5EWtYFTKu3rmtXSLkcBllB02YGBMIfmjFVbU95JjES4nWNAK5LvRlH-1Se_uHy96YYEDcSZuI5er2NIcA3fbgcKqq-6AUXrDvSnSut_d9WNBDFvGO3i7Klhs-gEY',
    tags: ['ARTESANAL'],
    stars: 4,
    reviews: 145,
    diet: ['Vegan'],
  ...
  },
  {
    ...
    category: 'Acidulados',
    price: 5.99,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA8sXldN92lkY1jHTe_PHBwDwsiG2QOllSf7JdaoGxybnVSYbXd_ntULS0HhFlWNJTbIhJojY10iYdLY6erneF3APq6GVQ7bx00GuiLCvwFJ2ctSmUCsWl-3n8i9-GeIjGIqJngz597bOP4u-ncMF-ybno3aR_Z-ZGk2gekjQGIbtcewMYTKX2wdbO3WKRpYNFS0NWY5f_0Sfgqo2ucLp8myRAQMlIU18k8n5swfccRay5203LRtUs_TJ5z_vlhFedl8SIctly0SD4',
  ...
  },
  {
    ...
    category: 'Gomitas',
    price: 12.50,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBW_R0yaBzAijbha2wbrpWE_kucWMQaJ8iOiSljgo0TG0QbWCwLgNNBX2Oe52xd8e1DXJuKgh1cvUjVCFssDEy79Laa5qDvOhI4TLGvICFlQ1qpbJfD3NcwKMT1QZmW5-uzQlLUrQ6GRNAHJXOf90NPHrXV8LegH2bZsXXcYPBkxJ2EH5ZETCZZu1kj_lF9H5LFn-s_IqgSuJosNh19y-hbIBxJsGsDvLlBZsh4_WytlZ37GaJQ_7jD79esjQtR3ETufWk8mRExvsk',
  ...
  },
  {
    ...
    category: 'Chocolates',
    price: 24.00,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDgyFGma4r5tf4ZWf_K1LBzT9rFlnnlNq6VwoexWlnMUDm3TqIpgQ0VGpY0IxwTAFwJ92ba5jICoVHj02WLmXlKYTJC12mKTx28fOVhvYwvAZi-wJcQ79PEg_1cX9co-stdT1Okc8U3CbrREi8mmPWrZBkfqzdnM1WBCG4Qpu79BW57ESwinctKjlWDMdEu4-in-_PgvHF6QKpB-rkSl4rWIBgnN-kCOLELe_iMRUaZrTKix38scGT7mcyq-Kkizhy6TebvpjU__CM',
...
export const TEAM_MEMBERS = [
  {
    name: 'Valentina G.',
    role: 'Fundadora & CEO',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAV8Cq1ch8kXuNOnnRjKwov8EyNOpgt2yyYxNztsYjE0HjFWaEGU0Eyiw3tQBgGpO8iE1MAc_XaNyJdx9eDEw-CI5izZHBcxonLFZHlk_rbaocfhu82Mt0GCpwR4t35owybd7WCWkvxjOlPUnivhElL7DSnfmdHAFn5rmCa5ogZIBLReeilPT_FPNx50d7OQbxjNtn41Xn7k_FJLhi_n5_sS04p4yogjLH_RPhlO-TiQnniNFsCoENLSqb7P0wyxNoO6Tj9dMOL3fE'
  },
  {
    name: 'Mateo R.',
    role: 'Maestro Confitero',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBhjh0cN6hWO-Jf7-9SjnIep6vOWU0cpzIHusXHhoKHpzesVytWgEd1DnbC_hwxw7_BWxj9sKlCa0abjtLjh5om0GMO__o9YJj--DvZtN--JryV96vqwmxOTfWW4CNzDKPtfha7hPzH1tGb7ESc7bgoTL5hncZFhShhA8gfU8tFfbyIRzDTn41wHmfU52YRyAO1r8sqAFmJpIDpDXHdTscBV4k8CZVQu9KUmP0ylcPdwvuxRxxyTIteCC8TocfVJ-_NVq7H0qPAdwQ'
  },
  {
    name: 'Elena S.',
    role: 'Diseño de Experiencia',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBnppGKn40yhl3MxJ23H5kJiloIMe1yDA_BWDpXKS39dgT9L9PcFYEUE97ittkJRGUS_FbKmZEXAGW0emqB1jTFNviXQLe3DswtbJST9W5cg4yXLoD0CQxipe5wzXfoa4dWDfPz8xXL9tyVDt1lklcRbQgzbXC7VCFZO9O1gJVLm-b11Iz-tfD2SK7HzQDFl7HFoP7d4h5xwrCj05YoMmx3_h1I1SOSWoPcG8CF0zodOOJPc2utxy1eYusEqcrdOvDqWC37tNH64CA'
  },
  {
    name: 'Julian M.',
    role: 'Logística Galáctica',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBvWMtlYvPTNoHWd6SeF3L85CRDa9OdfBX3HEWxvGBb4qDFbXBauQnp3gspNSB5ajerc_EQa7ZiQD52ZuvtIYgqvguZQfMkZm8aSEBqW9H3ilpjrGZKinvujoRPhdM7rZ6By5dVr_Zkp6yvCz94WCuGiKpNxgjk_tdaTzgyTp4dWRL8Ix8in4FG_NMqVcfgC5wH6t5UcCQC5z33Q9j5wEMC_gREphNh3vg87i4BGTdR4KJVAzZPYLnix5ytK0ggQwElXpQij6KwZw0'
  }
];

export const PILLARS = [
  {
    title: 'Calidad Mágica',
    desc: 'Cada ingrediente es seleccionado por su pureza y capacidad de evocar nostalgia, transformado mediante procesos artesanales únicos.',
    icon: 'magic_button',
    bg: 'bg-primary-fixed',
    text: 'text-primary'
  },
  {
    title: 'Sabor sin Fronteras',
    desc: 'Exploramos los confines del mundo para encontrar sabores exóticos que desafíen tu paladar y te lleven a nuevos mundos.',
    icon: 'public',
  ...
  {
    title: 'Corazón de Caramelo',
    desc: 'Somos una comunidad. Cada compra apoya a proveedores locales y prácticas de comercio justo en toda nuestra cadena.',
    icon: 'favorite',
